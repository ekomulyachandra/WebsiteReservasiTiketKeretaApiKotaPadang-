...
$bulan       = mysqli_query($koneksi, "SELECT MONTH(tgl_berangkat) FROM pembelian  ");
$penghasilan = mysqli_query($koneksi, "SELECT  FROM penjualan WHERE tahun='2016' order by id asc");
?>
<html>
    <head>
