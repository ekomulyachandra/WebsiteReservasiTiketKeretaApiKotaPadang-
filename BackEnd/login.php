          ...
          <div class="col-lg-6 d-flex align-items-center justify-content-center">
            <div class="auth-form-transparent text-left p-3">
              ...
              <form class="pt-3" method="post">
                ...
                <div class="my-3">
                  <input type="submit" name="submitt" value="LOGIN" class="btn btn-danger  auth-form-btn flex-grow mr-1" align="center" style="margin-left: 200dp;">
                </div>
              ...
              <?php
               ...
               if (isset($_POST['submitt'])){
                ...
                $login=mysqli_query($koneksi,"SELECT * FROM user WHERE username like '$user' AND password like'$pass'");
