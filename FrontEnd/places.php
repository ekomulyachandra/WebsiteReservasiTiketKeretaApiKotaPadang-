        ...
        <div class="row">
          ...
          <div class="col-lg-9">
            <div class="row"> 
              <?php
              include ('koneksi.php');
              $ambil=mysqli_query($koneksi,"SELECT kereta.*,kereta.id as id,kota1.namakota as dari1, kota2.namakota as ke1,kelas.id as idkelas,kelas.harga as harga,kelas.namakelas as nama_kelas 
              ...
              <div class="col-sm col-md-6 col-lg-4 ftco-animate">
                <div class="destination">
                  ...
                  <div class="text p-3">
                    <div class="d-flex">
                      <div class="one">
                        <h3><a href="#"><?= $data['dari1']?>-<?= $data['ke1']?></a></h3>
                        <p class="rate">
                          <i class="icon-star"></i>
                          <i class="icon-star"></i>
                          <i class="icon-star"></i>
